...
try:
    ...
    large_font = ImageFont.truetype(font_path, 225)  # Color title, 225pt
    medium_font = ImageFont.truetype(font_path, 115)  # Material/gauge and status, 115pt
    small_font = ImageFont.truetype(font_path, 70)   # Origin, 70pt
